  ...
  return (
    ...
    >
      ...
      <div className="min-w-0 flex-1">
        <p className="truncate text-xs font-medium text-text-primary group-hover:text-mcneese-blue">
          {citation.title}
        </p>
        {citation.snippet && (
        ...
        <p className="mt-1 flex items-center gap-1 text-[10px] text-mcneese-blue">
